import 'package:alan_ai_radio/Utils/ai_utils.dart';
import 'package:alan_ai_radio/model/radio.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
      //TODO: Enter below your alan sdk key
        "ENTER HERE YOUR ALAN SDK KEY!!!!!!!!!!!!!!!!!!!",
            ...
            VxSwiper.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Chip(
                  ...
                  label: Container(
                    width: 100,
                    child: s.text.semiBold.center.size(8).make(),
                  ),
                );
              },
            ),
                        ...
                        child: ZStack(
                          [
                            Positioned(
                              ...
                              child: VxBox(
                                      child: rad
                                          .category.text.uppercase.white.sm.bold
                                          .make()
                                          .p16())
                                  .height(50)
                                  .black
